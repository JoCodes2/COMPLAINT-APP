...
<head>
    ...
    <title>Sistem Pengaduan SRIKANDI</title>
            ...
            <div class=" col-12 footer-content mx-auto">
                <div class="row d-flex justify-content-center text-center">
                    <div class="col-md-4 justify-content-center">
                        <div>
                            <h5 class="font-popins sky ">Sistem Inforamsi Pengaduan SRIKANDI</h5>
                    ...
                    <div class="col-md-4 justify-content-center">
                        ...
                        <div>
                            <ul class="list-unstyled font-kanit">
                                ...
                                <li><a href="#" class="nav-footer">Data Pengaduan</a></li>
