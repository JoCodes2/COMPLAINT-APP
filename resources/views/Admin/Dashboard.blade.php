...
@section('content')
    <div class="page-inner">
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="card text-white mb-3 card-hover" style="background-color: #0d47a1;">
                    <div class="card-body">
                        ...
                        <h3 class="card-text" id="total-complaint">123</h3>
            ...
            <!-- Card Total Ditinjau -->
            <div class="col-sm-4">
                <div class="card text-white mb-3 card-hover" style="background-color: #2196f3;">
                    <div class="card-body">
            ...
            <div class="col-sm-4">
                <div class="card text-white mb-3 card-hover" style="background-color: #64b5f6;">
                    <div class="card-body">
                        <h5 class="card-title">Total Belum Ditinjau</h5>
                        <p class="card-text">Jumlah data yang belum ditinjau</p>
                        <h3 class="card-text" id="total-not-reviewed">78</h3>
                        <!-- Ganti dengan data dinamis jika diperlukan -->
                    </div>
                </div>
            </div>
